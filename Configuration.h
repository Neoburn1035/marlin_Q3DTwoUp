...
#define STRING_VERSION "1.0.2.2"
#define STRING_URL "q3dprinter.com"

#define STRING_SPLASH_LINE2 STRING_VERSION_CONFIG_H // will be shown during bootup in line2


#define STRING_CONFIG_H_AUTHOR "(Neoburn, default config)" // Who made the changes.
...
#define MACHINE_UUID "4d949328-7e9e-4fe1-ab14-43c1021549d2"
...
//AnUBIS Hotend PID
#ifdef AnUBIS
    #define  DEFAULT_Kp 37.05
    #define  DEFAULT_Ki 2.08
    #define  DEFAULT_Kd 164.81
#endif // PIDTEMP
...
//E3D Lite6 Hotend PID
#ifdef E3D
    #define  DEFAULT_Kp 47.63
    #define  DEFAULT_Ki 6.46
...
#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -20.80  // -below (always!)
 ...
 */
 ...
 //Old brass gear = 92.39496825379989
 //New stainless gear = 136.611842

#define HOMING_FEEDRATE {50*60, 50*60, 4*60, 0}  // set the homing speeds (mm/min)

#define DEFAULT_AXIS_STEPS_PER_UNIT   {88.88888888889,88.88888888889,390.468571428538,E_Step}  // Steps per MM For One and Two Up printers. (X, Y, Z, E)
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 10,175} // X,Y,Z Axis Extend and Retract angles
